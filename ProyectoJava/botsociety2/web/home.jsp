...
<div class="container">
    <div class="row" id="Crono">
      ...
      <div class="my-3 p-3 bg-white rounded box-shadow">
        <h6 class="border-bottom border-gray pb-2 mb-0">Empresas</h6>
        ...
        <div class="media text-muted pt-3">
          ...
          <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
            <div class="d-flex justify-content-between align-items-center w-100">
              <strong class="text-gray-dark"><%=em.getNombreEmpresa() %></strong>
            </div>
              <span class="d-block"><strong>Stand</strong> <%=(new StandDAO()).Leer(em.getIdStand()).getNumStand()%></span>
          </div>
        </div> 
