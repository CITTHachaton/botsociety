...
public class OfertaLaboralJpaController implements Serializable {
    ...
    public OfertaLaboralJpaController(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
    ...
    public void create(OfertaLaboral ofertaLaboral) throws RollbackFailureException, Exception {
    ...
    public void edit(OfertaLaboral ofertaLaboral) throws NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
            ...
            if (msg == null || msg.length() == 0) {
                Integer id = ofertaLaboral.getIdOferta();
