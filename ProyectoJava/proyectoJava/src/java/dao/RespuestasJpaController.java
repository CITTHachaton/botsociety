...
public class RespuestasJpaController implements Serializable {
    ...
    public RespuestasJpaController(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
    ...
    public void create(Respuestas respuestas) throws RollbackFailureException, Exception {
    ...
    public void edit(Respuestas respuestas) throws NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
