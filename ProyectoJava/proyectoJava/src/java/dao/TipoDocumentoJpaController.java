...
public class TipoDocumentoJpaController implements Serializable {
    ...
    public void create(TipoDocumento tipoDocumento) throws PreexistingEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            if (findTipoDocumento(tipoDocumento.getIdTipoD()) != null) {
    ...
    public void edit(TipoDocumento tipoDocumento) throws NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
            ...
            if (msg == null || msg.length() == 0) {
                Integer id = tipoDocumento.getIdTipoD();
